...
public class NaiveExecutorIndexer {
	...
	public static void main(String[] args) {
		...
		naiveExecutorIndexer.add(naiveExecutorIndexer.createWeblink(2000, "Use Final Liberally",
				"http://www.javapractices.com/topic/TopicAction.do?Id=23", "http://www.javapractices.com"));
		naiveExecutorIndexer.add(naiveExecutorIndexer.createWeblink(2001, "What is PECS?",
