...
public class WaitNotifyWithIncompleteInterruption {
	...
	public static void main(String[] args) {
		...
		incompleteInterruption.add(incompleteInterruption.createWeblink(2000, "Use Final Liberally",
				"http://www.javapractices.com/topic/TopicAction.do?Id=23", "http://www.javapractices.com"));
		incompleteInterruption.add(incompleteInterruption.createWeblink(2001, "What is PECS?",
