...
public class ExplicitLocksWithInterruption {
	...
	public static void main(String[] args) {
		...
		explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2000, "Use Final Liberally",
				"http://www.javapractices.com/topic/TopicAction.do?Id=23", "http://www.javapractices.com"));
		explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2001, "What is PECS?",
