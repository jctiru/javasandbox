...
public class FutureTimedGetIndexer {
	...
	public static void main(String[] args) {
		...
		futureTimedGetIndexer.add(futureTimedGetIndexer.createWeblink(2000, "Use Final Liberally",
				"http://www.javapractices.com/topic/TopicAction.do?Id=23", "http://www.javapractices.com"));
		futureTimedGetIndexer.add(futureTimedGetIndexer.createWeblink(2001, "What is PECS?",
